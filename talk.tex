...
\begin{frame}{The Subgraph Isomorphism Problem}
    ...
    \begin{tikzpicture}
        ...
        \node [vertex]   (T1) at (3.13, 0.5) { 1 };
        \node [vertexc1] (T5) at (4, 0) { 5 };
        \node [vertexc2] (T6) at (5, 0) { 6 };
        \node [vertexc3] (T3) at (5, 1) { 3 };
        \node [vertexc4] (T2) at (4, 1) { 2 };
        \node [vertex]   (T4) at (5.87, 0.5) { 4 };
