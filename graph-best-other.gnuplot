...
plot \
    ...
    "graph-best-other.data" u (($3 == 1 && $2 == 0 && $5 <= $8 && $5 <= $9 && $5 < 1e8)?$5:NaN):($7):(1) w p ps variable lc 1 pt 11 notitle, \
    ...
    "graph-best-other.data" u (($3 == 1 && $2 == 1 && $5 <= $8 && $5 <= $9 && $5 < 1e8)?$5:NaN):($7):(1) w p ps variable lc 1 pt 10 notitle, \
    ...
    "graph-best-other.data" u (($3 == 2 && $2 == 0 && $5 <= $8 && $5 <= $9 && $5 < 1e8)?$5:NaN):($7):(1) w p ps variable lc 1 pt 7 notitle, \
    ...
    "graph-best-other.data" u (($3 == 2 && $2 == 1 && $5 <= $8 && $5 <= $9 && $5 < 1e8)?$5:NaN):($7):(1) w p ps variable lc 1 pt 6 notitle, \
    ...
    "graph-best-other.data" u (($3 == 3 && $2 == 1 && $5 <= $8 && $5 <= $9 && $5 < 1e8)?$5:NaN):($7):(1) w p ps variable lc 1 pt 4 notitle, \
    ...
    "graph-best-other.data" u (($3 == 4 && $2 == 1 && $5 <= $8 && $5 <= $9 && $5 < 1e8)?$5:NaN):($7):(1) w p ps variable lc 1 pt 4 notitle, \
    ...
    "graph-best-other.data" u (($3 == 5 && $2 == 1 && $5 <= $8 && $5 <= $9 && $5 < 1e8)?$5:NaN):($7):(1) w p ps variable lc 1 pt 8 notitle, \
    ...
    "graph-best-other.data" u (($3 == 6 && $2 == 1 && $5 <= $8 && $5 <= $9 && $5 < 1e8)?$5:NaN):($7):(1) w p ps variable lc 1 pt 8 notitle, \
    ...
    "graph-best-other.data" u (($3 == 7 && $2 == 1 && $5 <= $8 && $5 <= $9 && $5 < 1e8)?$5:NaN):($7):(1) w p ps variable lc 1 pt 12 notitle, \
    ...
    NaN w p ps 1.5 pt 7 lc 1 ti "LAD", \
